    ...
    function n(r) {
      for (
        var o = function(r) {
          ...
          e = 'log,debug,info,warn,warning,error,critical,global,configure,handleUncaughtException,handleUnhandledRejection,_createItem,wrap,loadFull,shimId,captureEvent,captureDomContentLoaded,captureLoad'.split(
            ','
          ),
          n = 0;
        n < e.length;
      ...
      return function(o) {
        if (!o && !window._rollbarInitialized) {
          ...
          for (
            ...
            n || (n = e.handler),
              e.handler._swapAndProcessMessages(l, e.messages);
